  ...
  tabs: [
    {
      ...
      links: [
        ...
        { title: "What To Do After a Car Accident", description: "Step-by-step guide for protecting your rights after a collision", href: "https://themvp.com/car-accident-lawyer/", image: "/topical/icon-svc-investigate.svg" },
        { title: "Self-Driving Car Accident Cases", description: "Understanding liability in autonomous vehicle collisions in California", href: "https://themvp.com/car-accident-lawyer/", image: "/topical/icon-pa-rideshare.svg" },
        { title: "Distracted Driving Accidents", description: "How to handle insurance claims after a distracted-driver crash", href: "https://themvp.com/car-accident-lawyer/", image: "/topical/icon-svc-liability.svg" },
      ],
    },
    {
      ...
      links: [
        ...
        { title: "What a Personal Injury Attorney Does", description: "From slip and falls to wrongful death, understand your case type", href: "https://themvp.com/sacramento/personal-injury-lawyer/", image: "/topical/icon-svc-defense.svg" },
        { title: "Catastrophic Injury Lawyer", description: "Representation for life-changing injuries with long-term impact", href: "https://themvp.com/sacramento/personal-injury-lawyer/", image: "/topical/icon-svc-damages.svg" },
        { title: "Wrongful Death Claims", description: "Compensation for families who lost a loved one to negligence", href: "https://themvp.com/sacramento/personal-injury-lawyer/", image: "/topical/icon-pa-wrongful-death.svg" },
      ],
    },
    {
      label: "Resources",
      links: [
        { title: "About MVP Accident Attorneys", description: "Meet the team and learn what makes MVP different", href: "https://themvp.com/faq/", image: "/topical/icon-svc-negotiate.svg" },
        { title: "Free Case Consultation", description: "Schedule a free, no-obligation consultation with the firm", href: "https://themvp.com/faq/", image: "/topical/icon-phase-consult.svg" },
        { title: "Frequently Asked Questions", description: "Answers to the most common personal injury questions in California", href: "https://themvp.com/faq/", image: "/topical/icon-svc-insurance.svg" },
        { title: "Client Testimonials", description: "Read real reviews from past MVP clients across California", href: "https://themvp.com/faq/", image: "/topical/icon-phase-resolve.svg" },
      ],
    },
  ],
}
