...
export const topicalEntryGrid = {
  ...
  tabs: [
    ...
    },
    {
      label: "Resources",
      links: [
        { title: "About MVP Accident Attorneys", description: "Meet the team and learn what makes MVP different", href: "https://themvp.com/about-us/", image: "/topical/icon-svc-negotiate.svg" },
        { title: "Free Case Consultation", description: "Schedule a free, no-obligation consultation with the firm", href: "https://themvp.com/contact-us/", image: "/topical/icon-phase-consult.svg" },
        ...
        { title: "Client Testimonials", description: "Read real reviews from past MVP clients across California", href: "https://themvp.com/testimonials/", image: "/topical/icon-phase-resolve.svg" },
      ],
    },
  ],
}
