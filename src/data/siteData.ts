...
export const attorney = {
  ...
  bio: [
    ...
    "Brett Sachs founded MVP Accident Attorneys in Southern California to treat clients like family. Brett Sachs moved from the Midwest after his wife relocated for work. His firm focuses on car accidents, wrongful death, and pool drowning cases. MVP refers cases to specialists outside their focus area. This ensures clients get the best attorney for their specific situation."
  ],
...
export const faqGroups = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "HowDoes The You Interview Explain Contingency Fee Arrangements for Injury Lawyers?",
        level: "h2",
