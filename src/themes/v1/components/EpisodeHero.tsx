...
import { episode as staticEpisode, siteConfig, footer, episodes as staticEpisodesData } from '@/data/siteData'
        ...
        <div className="max-w-container mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="text-xs text-white/60 uppercase">Available on</div>
                    <div className="text-base font-bold text-white">Apple Podcasts</div>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div className="relative w-full flex items-center justify-center">
              <div className="w-full max-w-[480px] mx-auto aspect-square rounded-2xl overflow-hidden">
                <img
                  src={coverImage}
                  alt={ep.title}
