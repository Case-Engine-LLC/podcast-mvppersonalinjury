    ...
    <section id="contact" className="py-24 bg-[#f1f2f4]">
      ...
      <div className="max-w-container mx-auto px-6 md:px-12">
        <div className="bg-white rounded-[12px] shadow-sm overflow-hidden flex flex-col md:flex-row">
          ...
          {/* CTA — routes to firm site, no local form */}
          <div className="md:w-2/3 p-12 flex flex-col justify-center">
            <h3 className="text-[28px] md:text-[32px] font-bold text-black mb-4 leading-tight">
              Free Case Review
            </h3>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-black text-white px-8 py-4 rounded-[3px] font-bold text-[14px] uppercase tracking-[0.7px] hover:bg-black/80 transition-all self-start"
            >
              Contact the Firm
              <ArrowUpRight size={16} />
            </a>
            <p className="text-[12px] text-black/40 mt-4">
              Opens {firmContactUrl.replace(/^https?:\/\//, '')} in a new tab.
            </p>
          </div>
        </div>
      </div>
