...
import { content, attorney, episode, chaptersDescription, episodes as episodesData } from '@/data/siteData'
...
function EpisodeContent() {
  ...
  const episodeChapters = episodesData[0]?.chapters ?? []
  const episodeConcepts = episodesData[0]?.concepts ?? []
