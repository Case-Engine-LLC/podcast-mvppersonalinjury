...
function EpisodeHero() {
  const coverImage = episodesData[0]?.logo
    ...
    <section className="relative pt-28 pb-16 md:pt-32 md:pb-20 bg-[#f4f2ed]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-[#091830]/50 mb-10">
          ...
          <span>/</span>
          <span className="text-[#10284B] font-medium">Episode {episode.number}</span>
        </nav>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a
               ...
               {...(/^https?:\/\//.test(String(siteConfig.platformLinks.spotify)) ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
              ...
              <a
               ...
               {...(/^https?:\/\//.test(String(siteConfig.platformLinks.apple)) ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
