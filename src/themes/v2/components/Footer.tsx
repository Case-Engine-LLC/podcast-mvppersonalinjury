...
import { footer, episodes, siteConfig } from '@/data/siteData'
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 bg-white rounded-br-xl rounded-tl-xl flex items-center justify-center text-[#091830] font-heading font-bold italic">M</div>
            <span className="font-heading font-bold text-xl tracking-tight text-white">MVP Legal</span>
          </div>
          ...
          <div className="flex gap-4">
            <a href={siteConfig.platformLinks.spotify} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF9E00] transition-colors" {...(/^https?:\/\//.test(String(siteConfig.platformLinks.spotify)) ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
            ...
            <a href={siteConfig.platformLinks.apple} className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#FF9E00] transition-colors" {...(/^https?:\/\//.test(String(siteConfig.platformLinks.apple)) ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
