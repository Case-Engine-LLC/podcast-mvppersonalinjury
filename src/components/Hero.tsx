...
const Hero = () => {
  return (
    <section className="hero-section  pt-[6rem]">
      {/* Marquee Banner */}
      ...
      {/* Hero Content */}
      <div className="max-w-container mx-auto px-6 md:px-12 pt-8 md:pt-12 pb-8 md:pb-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 items-center mb-8 md:mb-10">
          {/* Left Content - 60% */}
          <div className="md:col-span-3">
            {/* Label */}
            <div className="inline-block bg-white/10 backdrop-blur-sm px-4 py-2 rounded-md text-xs font-bold text-white uppercase tracking-widest mb-4">
              {siteConfig.podcastName}
            </div>

            {/* Heading */}
            <h1 className="text-4xl md:text-5xl font-bold leading-tighter text-white mb-4">
              {content.heroTitle}
            </h1>

            {/* Description */}
            <p className="text-base md:text-lg text-white/80 leading-relaxed mb-6 md:mb-8 max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                ...
                className="flex items-center gap-3 px-6 py-4 rounded-2xl transition-all hover:scale-105 w-full sm:w-auto sm:min-w-[15rem]"
                style={{
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-lg font-bold text-white">Apple Podcast</div>
                </div>
              </Link>
          ...
          {/* Right Image - 40% */}
          <div className="md:col-span-2 relative w-full h-[280px] md:h-[380px] flex items-center justify-center">
            <div className="w-full h-full rounded-2xl border-2 border-white/20 flex items-center justify-center">
              <svg width="100" height="100" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="45" cy="35" r="12" stroke="white" strokeOpacity="0.3" strokeWidth="2"/>
                <path d="M15 105 L45 65 L75 90 L105 50" stroke="white" strokeOpacity="0.3" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
          </div>
        </div>
